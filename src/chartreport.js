...
{isEnlarged && (
  ...
  <div className="absolute inset-0 bg-gray-100 -z-10"></div>
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-4xl font-light mb-6">$95</p>
          <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-12 py-3 uppercase tracking-wider font-medium transition-colors">
            Order Now
          </button>
        </div>
      </div>
